...
DROP TABLE DP_STG1.sales_may_11_20;

REFRESH DP_STG1.sales_may_11_20;

show create table DP_STG1.sales_may_11_20;

SELECT * FROM dp_stg1.sales_may_11_20 LIMIT 100;
...
CREATE TABLE DP_STG1.sales_may_11_20
(
...
#USE THE FOLLOWING COMMAND TO LOAD DATA IN sales_may_11_20 TABLE

#" sudo -u hdfs hadoop fs -put /hdfs/AW_DS_DP_STG1/Sales_May11-20.csv /user/hive/warehouse/dp_stg1.db/sales_may_11_20"