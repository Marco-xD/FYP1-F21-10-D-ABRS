...
DROP TABLE DP_STG1.sales_may_06_10;

REFRESH DP_STG1.sales_may_06_10;

show create table DP_STG1.sales_may_06_10;

SELECT * FROM dp_stg1.sales_may_06_10 LIMIT 100;
...
CREATE TABLE DP_STG1.sales_may_06_10
(
...
# USE THE FOLLOWING COMMAND TO LOAD DATA IN sales_may_06_10
# "sudo -u hdfs hadoop fs -put /hdfs/AW_DS_DP_STG1/Sales_May06-10.CSV /user/hive/warehouse/dp_stg1.db/sales_may_06_10"