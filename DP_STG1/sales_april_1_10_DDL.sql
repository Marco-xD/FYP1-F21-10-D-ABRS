...
##ERROR IN LOADING DATA TO THIS FILE (SCREENSHOT ATTACHED)

DROP TABLE DP_STG1.sales_april_1_10;

REFRESH DP_STG1.sales_april_1_10;

show create table DP_STG1.sales_april_1_10;

SELECT * FROM dp_stg1.sales_april_1_10 LIMIT 100;
...
CREATE TABLE DP_STG1.sales_april_1_10
(
...
#USE THIS COMMAND TO LOAD DATA IN sales_april_1_10 TABLE

#"sudo -u hdfs hadoop fs -put /hdfs/AW_DS_DP_STG1/Sales_April1-10.csv /user/hive/warehouse/dp_stg1.db/sales_april_1_10"
