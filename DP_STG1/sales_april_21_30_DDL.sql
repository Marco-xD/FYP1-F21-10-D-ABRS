...
DROP TABLE DP_STG1.sales_april_21_30;

REFRESH DP_STG1.sales_april_21_30;

show create table DP_STG1.sales_april_21_30;

SELECT * FROM dp_stg1.sales_april_21_30 LIMIT 100;
...
CREATE TABLE DP_STG1.sales_april_21_30
(
...
#USE THIS COMMAND TO LOAD DATA IN sales_april_21_30 TABLE

#"sudo -u hdfs hadoop fs -put /hdfs/AW_DS_DP_STG1/Sales_April21-30.csv /user/hive/warehouse/dp_stg1.db/sales_april_21_30"